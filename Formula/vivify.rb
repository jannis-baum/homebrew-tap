class Vivify < Formula
  ...
  on_macos do
    on_arm do
      ...
      depends_on "zstd"
      depends_on "simdutf"
      url "https://github.com/jannis-baum/Vivify/releases/download/v0.10.0/vivify-macos-arm.tar.gz"
    ...
    on_intel do
      ...
      depends_on "sqlite"
      depends_on "zstd"
      url "https://github.com/jannis-baum/Vivify/releases/download/v0.10.0/vivify-macos-x86.tar.gz"
  ...
  on_linux do
    ...
    depends_on "uvwasi"
    depends_on "zstd"
    url "https://github.com/jannis-baum/Vivify/releases/download/v0.10.0/vivify-linux.tar.gz"
